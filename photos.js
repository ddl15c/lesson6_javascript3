...
function previewFive() {
   ...
   //add src values to two new img elements 
...
function createEventListeners() {
 ...
 // the leftArrow() function will be excuted when the user clicks the left navigation arrow button 
 leftarrow.addEventListener("click", leftArrow, false);
 
 //declare variables for document with id of rightarrow 
